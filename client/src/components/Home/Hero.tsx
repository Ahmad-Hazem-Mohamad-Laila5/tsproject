...
import { BiArrowFromLeft, BiLeaf } from "react-icons/bi";
      ...
      <div className=" relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className=" max-w-xl xl:pl-10">
          <span className=" inline-flex items-center gap-1.5 px-4 py-1.5 text-xs font-semibold text-orange-300 bg-orange-300/10 rounded-full mb-5">
            <BiLeaf className=" size-3" />
            Farm-freash & Organic
          </span>
          <h1 className=" font-serif text-4xl sm:text-xl lg:text-6xl text-white leading-tight mb-5">
            Nourish your home{" "}
            <span className=" text-orange-300">with Earth's finest</span>
          </h1>
          ...
          <div className=" flex flex-wrap gap-3">
            ...
            >
              Shop Now <BiArrowFromLeft className=" size-4" />
            </Link>
            <Link
              to={"/products"}

...
const Products = () => {
  ...
  const avtiveCategory = categoriesData.find((c) => c.slug === category);
    ...
    <div className=" min-h-screen bg-app-cream">
      <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <nav className=" flex items-center gap-2 text-sm text-app-text-light mb-6">
          ...
          <span>/</span>
          <span>{avtiveCategory ? avtiveCategory.name : "All Products"}</span>
        </nav>
            ...
            <div className=" flex items-center justify-between mb-6">
              <div className="">
                <h1 className=" text-2xl font-semibold text-app-green">
                  {avtiveCategory ? avtiveCategory.name : "All Products"}
                </h1>
              ...
              <div className=" flex flex-col lg:items-center gap-3">
                ...
                <div className=" relative">
                  ...
                  >
                    ...
                    <option value="rating">Top ated</option>
        ...
        <>
          ...
          <div className=" fixed bottom-0 left-0 right-0 bg-white z-50 rounded-t-2xl max-h-[80vh] overflow-y-auto animate-slide-in-up">
            <div className=" flex items-center justify-between p-4 border-b border-app-border">
              <h3 className=" text-lg font-semibold to-app-green">Filters</h3>
              <button
